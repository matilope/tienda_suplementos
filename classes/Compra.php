...
class Compra
{
    ...
    public function getCompras(): array
    {
        ...
        $query = "SELECT compras.*, detalle_compra.compra_id as compra_id, detalle_compra.producto_id as producto_id, detalle_compra.precio as precio, detalle_compra.cantidad as cantidad, detalle_compra.sabor as sabor FROM compras LEFT JOIN detalle_compra ON compra_id = compras.id;";
