...
<div class="crear-editar-productos">
    ...
    <?php } else { ?>
        <div class="aviso">
            <h1 class="mt-3 mb-4">El producto con ese ID no se ha encontrado.</h1>
            <p class="lead mb-4">Vuelva a intentarlo yendo a la administración de productos y apretando en editar</p>
            <a href="?seccion=admin_productos" class="btn btn-lg btn-primary">Ir a administración</a>
        </div>
    <?php } ?>
</div>